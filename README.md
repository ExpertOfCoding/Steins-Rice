...
3. kitty (terminal)
4. btop ( gorev yoneticisi gibi )
5. yazi ( Dosya yoneticisi )
6. VLC (Muzik/Video calar)
7. LibreWolf (Tarayici)
8. Calibre (E-kitap Epub)
9. zsh ve powerlevel10k ( NE OLDUKLARINI BILMIYORSANIZ KURMAYIN !!! )
